    ...
    class Car : Vehicle
{
    ...
    public Car(string type, string brand, string modelByYear, double price, int engine, string model, int numberOfDoors)
        : base(type, brand, modelByYear, price)
    {
        this.engine = engine;
        this.model = model;
    ...
    public override bool Equals(object obj)
    {
        ...
        else
        {
            return this.brand.Equals(carItem.brand) &&
                   ...
                   this.modelByYear.Equals(carItem.modelByYear); 
        }
    }
